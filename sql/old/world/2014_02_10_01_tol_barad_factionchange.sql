...
DELETE FROM `player_factionchange_reputations` WHERE `alliance_id`=1177 AND `horde_id`=1178;
INSERT INTO `player_factionchange_reputations` (`alliance_id`, `horde_id`) VALUES (1177, 1178);

-- Spectral Steed & Spectral Wolf mounts
DELETE FROM `player_factionchange_spells` WHERE `alliance_id`=92231 AND `horde_id`=92232;
