...
public:
    ...
    struct boss_unsleepingAI: public BossAI
    {
        ...
        void Reset()
        {
			...
			Creature* trigger = GetClosestCreatureWithEntry(me, 553120, 200.0f);
			if (trigger)
			    trigger->AI()->Reset();
        ...
        void UpdateAI(uint32 const diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_BLOOD_SUMMON:
				    me->GetMotionMaster()->MovePoint(0, -1765.66f, -3034.35f, -182.38f);
                    ...
                    case 0:
                        ...
                        if(IsHeroic())
						{
							...
							instance->DoSendNotifyToInstance("|cFFFFFC00 Yor\'sahj Summoned |cFF404040 DARK |cFFFFFC00 AND |cFF3F7F62 COBALT |cFFFFFC00 AND |cFFFF0000 CRIMSON |cFFFFFC00 AND |cFFFF6A00 GLOWING |cFFFFFC00 Globules");
						}
						else
						    instance->DoSendNotifyToInstance("|cFFFFFC00 Yor\'sahj Summoned |cFF404040 DARK |cFFFFFC00 AND |cFF3F7F62 COBALT |cFFFFFC00 AND |cFFFF0000 CRIMSON |cFFFFFC00 Globules");
                        Talk(YELL1);
						Talk(WHISPER1);
                        break;
                    case 1:
						...
						{
                            me->SummonCreature(NPC_CRIMSON_BLOOD, SummonPositions[2], TEMPSUMMON_MANUAL_DESPAWN);
							instance->DoSendNotifyToInstance("|cFFFFFC00 Yor\'sahj Summoned |cFFFF6A00 GLOWING |cFFFFFC00 AND |cFF4CB200 ACIDIC |cFFFFFC00 AND |cFFB200FF SHADOWED |cFFFFFC00 AND |cFFFF0000 CRIMSON |cFFFFFC00 Globules");
						}
						else
						    instance->DoSendNotifyToInstance("|cFFFFFC00 Yor\'sahj Summoned |cFFFF6A00 GLOWING |cFFFFFC00 AND |cFF4CB200 ACIDIC |cFFFFFC00 AND |cFFB200FF SHADOWED |cFFFFFC00 Globules");
                        Talk(YELL1);
						Talk(WHISPER1);
                        break;
                    case 2:
						...
						{
                            me->SummonCreature(NPC_ACIDIC_BLOOD, SummonPositions[4], TEMPSUMMON_MANUAL_DESPAWN);
							instance->DoSendNotifyToInstance("|cFFFFFC00 Yor\'sahj Summoned |cFF404040 DARK |cFFFFFC00 AND |cFF3F7F62 COBALT |cFFFFFC00 AND |cFFB200FF SHADOWED |cFFFFFC00 AND |cFF4CB200 ACIDIC |cFFFFFC00 Globules");
						}
						else
						    instance->DoSendNotifyToInstance("|cFFFFFC00 Yor\'sahj Summoned |cFF404040 DARK |cFFFFFC00 AND |cFF3F7F62 COBALT |cFFFFFC00 AND |cFFB200FF SHADOWED |cFFFFFC00 Globules");
                        Talk(YELL2);
						Talk(WHISPER2);
                        break;
                    case 3:
						...
						{
                            me->SummonCreature(NPC_SHADOWED_BLOOD, SummonPositions[5], TEMPSUMMON_MANUAL_DESPAWN);
							instance->DoSendNotifyToInstance("|cFFFFFC00 Yor\'sahj Summoned |cFFFF6A00 GLOWING |cFFFFFC00 AND |cFF4CB200 ACIDIC |cFFFFFC00 AND |cFFFF0000 CRIMSON |cFFFFFC00 AND |cFFB200FF SHADOWED |cFFFFFC00 Globules");
						}
						else
						    instance->DoSendNotifyToInstance("|cFFFFFC00 Yor\'sahj Summoned |cFFFF6A00 GLOWING |cFFFFFC00 AND |cFF4CB200 ACIDIC |cFFFFFC00 AND |cFFFF0000 CRIMSON |cFFFFFC00 Globules");
                        Talk(YELL2);
						Talk(WHISPER2);
                        break;						
                    }
                    events.ScheduleEvent(EVENT_BLOOD_SUMMON, 82000);
					events.ScheduleEvent(EVENT_ENABLE_MOVE, 22000);
                    break;
                ...
                case EVENT_COID_BOLT:
                    ...
                    if(me->HasAura(SPELL_GLOWING_BLOOD_OF_SHUMA))
                        events.ScheduleEvent(EVENT_COID_BOLT, urand(4000, 5000));
                    else
                        events.ScheduleEvent(EVENT_COID_BOLT, urand(12000, 30000));
                    break;
                ...
                case EVENT_SEARING_BLOOD:
                    if(me->HasAura(SPELL_CRIMSON_BLOOD_OF_SHUMA))
                    {
                        ...
                        events.ScheduleEvent(EVENT_SEARING_BLOOD, urand(5000,12000));
                    }
                    else
                ...
                case EVENT_FORGOTTEN_ONE:
                    if(me->HasAura(SPELL_BLACK_BLOOD_OF_SHUMA))
                    {
                        ...
                        events.ScheduleEvent(EVENT_FORGOTTEN_ONE, urand(28000,30000));
                    }
                    else
                ...
                case EVENT_DIGESTIVE_ACID:
                    if(me->HasAura(SPELL_ACIDIC_BLOOD_OF_SHUMA))
                    {
                        ...
                        events.ScheduleEvent(EVENT_DIGESTIVE_ACID, urand(5000,12000));
                    }
                    else
                        ...
                        for (Map::PlayerList::const_iterator i = PlayerList.begin(); i != PlayerList.end(); ++i)
                            if (i->getSource()->isAlive())
							    if (me->GetExactDist(i->getSource()) < 30.0f)
								    i->getSource()->SetPower(POWER_MANA, i->getSource()->GetMaxPower(POWER_MANA));
            ...
            void UpdateAI(uint32 const diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_PSYCHIC_SLICE:
                        ...
                        events.ScheduleEvent(EVENT_PSYCHIC_SLICE, urand(5000,12000));
                        break;
                    }
                }
            }
...
class npc_yorsahj_intro : public CreatureScript
{
    public:
        npc_yorsahj_intro() : CreatureScript("npc_yorsahj_intro") { }

        CreatureAI* GetAI(Creature* creature) const
        {
            return GetDragonSoulAI<npc_yorsahj_introAI>(creature);
        }

        struct npc_yorsahj_introAI : public ScriptedAI
        {
            npc_yorsahj_introAI(Creature* creature) : ScriptedAI(creature)
            {
                instance = creature->GetInstanceScript();
				intro = false;
            }
            ...
            void MoveInLineOfSight(Unit* who)
            {
			    ...
			    intro = true;
				Creature* yorsahj = GetClosestCreatureWithEntry(me, 55312, 100.0f);
				if (yorsahj)
				{
			        yorsahj->AI()->Talk(YELL_INTRO);				
			        yorsahj->AI()->Talk(WHISPER_INTRO);
				}
		    }		
        };
};
